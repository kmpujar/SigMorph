...
filePre='./Data/'
fileList=['UD_English-EWT/en_ewt-um-train.conllu']
list1=[2,5]
for file in fileList:
    with open(filePre+file) as fin:
...
filePre='./Data/'
fileList=['UD_English-EWT/en_ewt-um-dev.conllu']
list1=[2,5]
for file in fileList:
    with open(filePre+file) as fin:
         rows = ( line.split('\t') for line in fin if line[0]!='#' and line[0]!=' ' )
...
# precision recall and F1 to be calculated
