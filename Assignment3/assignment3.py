...
def multiLayer(Xmatrix,Ymatrix,x_test,layers,batchNorm):
	retTag=pd.DataFrame()
	...
	print(type(get_2nd_layer_output))
	print(get_2nd_layer_output)
...
def main():
	...
	for i in range(len(testFileList)):
		...
		print(testV.shape)
		print(testTagV.shape)
		#kerasMaxEnt(trainV,tagV,testV)
		multiLayer(trainV,tagV,testV,2,True)
		break
